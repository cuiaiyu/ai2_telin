...
# MODEL_WEIGHT="baseline_w_cn_all_cs_v3"
# MODEL_WEIGHT="baseline_w_cn_all_cs_v3_contd"
# MODEL_WEIGHT="baseline_w_cn_all_cs_v3_40k"
# MODEL_WEIGHT="baseline_w_cn_all_cs_v3_bz_8_gac_4"
MODEL_WEIGHT="baseline_w_cn_all_cs_v3_bz_8_gac_4_20k"
