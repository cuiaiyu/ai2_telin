...
f = open("atomic_which_one_qa.jsonl", "r")
l = open("atomic_which_one_qa-labels.lst", "r")
...
ft = open("atomic_which_one_qa-train-dev/train.jsonl", "w")
lt = open("atomic_which_one_qa-train-dev/train-labels.lst", "w")
fe = open("atomic_which_one_qa-train-dev/dev.jsonl", "w")
le = open("atomic_which_one_qa-train-dev/dev-labels.lst", "w")
