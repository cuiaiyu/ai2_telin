...
f = open("atomic_attr_qa_random_name.jsonl", "r")
...
ft = open("atomic_attr_qa_random_name-train-dev/train.jsonl", "w")
lt = open("atomic_attr_qa_random_name-train-dev/train-labels.lst", "w")
fe = open("atomic_attr_qa_random_name-train-dev/dev.jsonl", "w")
le = open("atomic_attr_qa_random_name-train-dev/dev-labels.lst", "w")
